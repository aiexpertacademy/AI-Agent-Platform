...
const RESUME_TEMPLATE_SEED = [
  ...
  { slug:'executive-blue', name:'Executive Blue', category:'Professional', style:'Banking Style', layout:'single', description:'Bold navy header with clean white body. Perfect for senior management and finance.', accentColor:'#0c2461', headerBg:'#0c2461', sidebarBg:null, headerText:'#ffffff', featured:false, tags:['navy','executive','banking','formal'], promptStyle:'SINGLE-COLUMN EXECUTIVE STYLE: Bold full-width navy (#0c2461) header — name large white serif, job title smaller white, contact row in light gray below. Body: white background, navy uppercase section titles with full-width thin navy underline rule. Cambria/Georgia serif. Generous spacing. Banking, finance, law focused.' },
  { slug:'clean-minimal', name:'Clean Minimal', category:'Professional', style:"Jake's Resume Style", layout:'single', description:'Ultra-clean ATS-friendly resume. Pure black and white for maximum compatibility.', accentColor:'#000000', headerBg:'#ffffff', sidebarBg:null, headerText:'#000000', featured:true, tags:['minimal','ats-friendly','clean','black-white'], promptStyle:'ULTRA-MINIMAL ATS STYLE: No colors — only black and white. Name centered large bold at top, contact info on one line separated by | pipes. Section headers: bold uppercase with simple thin horizontal rule. No borders, columns, or decorative elements. Helvetica/Arial sans-serif. Max whitespace. Designed to pass ATS systems perfectly.' },
  { slug:'european-cv', name:'European CV', category:'Professional', style:'Europass Style', layout:'single', description:'Standard European Curriculum Vitae format with structured layout and photo section.', accentColor:'#003399', headerBg:'#003399', sidebarBg:null, headerText:'#ffffff', featured:false, tags:['europass','european','structured','formal'], promptStyle:'EUROPASS EUROPEAN CV STYLE: Blue (#003399) header bar with white "Curriculum Vitae" label above name. Name large bold white. Photo placeholder circle on right of header. Two-column info section below header. Section labels in blue bold left column (~25%), content right column. Blue horizontal rule separates each section. Arial font. Very structured.' },
  { slug:'corporate-gray', name:'Corporate Gray', category:'Professional', style:'Clean Corporate', layout:'single', description:'Sophisticated charcoal-toned design for business professionals and managers.', accentColor:'#4a5568', headerBg:'#2d3748', sidebarBg:null, headerText:'#ffffff', featured:false, tags:['gray','corporate','sophisticated','neutral'], promptStyle:'CORPORATE GRAY STYLE: Dark charcoal (#2d3748) header, white bold name, light gray job title. Body: warm white background, gray (#4a5568) section titles with thin gray bottom border. Inter/System UI sans-serif. Balanced, mature, business-focused.' },
  { slug:'academic-traditional', name:'Academic Traditional', category:'Professional', style:'Academic Standard', layout:'single', description:'Clean academic CV for faculty, researchers, and postdocs.', accentColor:'#7b341e', headerBg:'#ffffff', sidebarBg:null, headerText:'#1a1a1a', featured:false, tags:['academic','research','publications','traditional'], promptStyle:'ACADEMIC TRADITIONAL: Left-aligned header — name large bold serif, title/department, institution, contact stacked. Brick-red (#7b341e) section headers in small caps with hairline underline. Sections: Education, Research/Publications, Teaching, Presentations, Awards. Publications in bibliography format. Times New Roman/Georgia serif.' },
  { slug:'financial-pro', name:'Financial Pro', category:'Professional', style:'Finance & Consulting', layout:'single', description:'Deep navy design for investment banking and consulting.', accentColor:'#1B4F72', headerBg:'#1B4F72', sidebarBg:null, headerText:'#ffffff', featured:false, tags:['finance','banking','consulting','metrics'], promptStyle:'FINANCIAL PRO STYLE: Deep navy (#1B4F72) header, white name, white title, contact in one line. Body: white with navy section title bars (full-width colored band, white text inside). Every bullet has metrics and impact numbers. Cambria serif, precise layout.' },
  { slug:'consulting-elite', name:'Consulting Elite', category:'Professional', style:'McKinsey/BCG Style', layout:'single', description:'Achievement-focused design used by top consulting firm candidates.', accentColor:'#153060', headerBg:'#153060', sidebarBg:null, headerText:'#ffffff', featured:false, tags:['consulting','achievement','dense','structured'], promptStyle:'CONSULTING ELITE: Dark navy (#153060) header, white name + title. Experience: bold role + company on same line, date right-aligned. EVERY bullet uses Impact-Action-Context format with quantified metrics. Em-dash (—) bullet markers. Dense text, max information per line. McKinsey/BCG resume format.' },
  { slug:'awesome-cv', name:'Awesome CV', category:'Creative', style:'Colored Sidebar', layout:'sidebar', description:'The most popular resume template on GitHub. Teal sidebar with clean structured content.', accentColor:'#00ADB5', headerBg:'#00ADB5', sidebarBg:'#00ADB5', headerText:'#ffffff', featured:true, tags:['teal','sidebar','popular','modern'], promptStyle:'AWESOME-CV STYLE: Teal (#00ADB5) LEFT sidebar (30% width) — white name, white contact info each line with icon prefix, white skill tags. Right main: white background, each section has teal uppercase header. Experience: bold role, teal company name, gray date right-aligned, teal dash bullet markers. Helvetica Neue sans-serif.' },
  { slug:'friggeri-dark', name:'Friggeri Dark', category:'Creative', style:'Dark Sidebar', layout:'sidebar', description:'Striking dark left sidebar with vibrant section accents. Bold and memorable.', accentColor:'#e74c3c', headerBg:'#2c3e50', sidebarBg:'#2c3e50', headerText:'#ffffff', featured:true, tags:['dark','sidebar','striking','bold'], promptStyle:'FRIGGERI DARK STYLE: Dark (#2c3e50) left sidebar — name in large white font, white contact info. Right main: white body, section titles in RED (#e74c3c) uppercase. Experience: role bold, company in red, date gray small. Thin colored rule separates sections. Lato/Roboto sans-serif.' },
  { slug:'creative-vivid', name:'Creative Vivid', category:'Creative', style:'Gradient Header', layout:'single', description:'Vivid purple gradient header for creative professionals.', accentColor:'#8B5CF6', headerBg:'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', sidebarBg:null, headerText:'#ffffff', featured:false, tags:['gradient','creative','purple','modern'], promptStyle:'CREATIVE VIVID STYLE: Purple gradient header (from #667eea to #764ba2), white name large bold, job title lighter white. Body: white background, purple (#8B5CF6) section titles with subtle left border. Skills as purple pill chips. Poppins or Space Grotesk sans-serif. For designers, marketers, creatives.' },
  { slug:'designer-portfolio', name:'Designer Portfolio', category:'Creative', style:'Portfolio Focus', layout:'two-column', description:'Two-column layout to showcase creative projects and design skills.', accentColor:'#F59E0B', headerBg:'#1a1a1a', sidebarBg:null, headerText:'#ffffff', featured:false, tags:['designer','portfolio','amber','two-column'], promptStyle:'DESIGNER PORTFOLIO STYLE: Dark (#1a1a1a) header, white name, amber (#F59E0B) accent subtitle. Two-column body: LEFT (35%): Skills in amber-bordered groups, Tools, Languages. RIGHT (65%): Experience with amber dot markers, Projects with amber left border. Montserrat geometric sans-serif.' },
  { slug:'bold-statement', name:'Bold Statement', category:'Creative', style:'Bold Typography', layout:'single', description:'Massive bold typography with dramatic visual contrast for creative roles.', accentColor:'#E53E3E', headerBg:'#ffffff', sidebarBg:null, headerText:'#1a1a1a', featured:false, tags:['bold','typography','red','dramatic'], promptStyle:'BOLD STATEMENT STYLE: White background throughout. Name in MASSIVE black font (48-60pt). Red (#E53E3E) thin rule below name. Contact info tiny minimal. Section headers use large bold numbers (01, 02, 03) with section name beside. Very generous whitespace. Dramatic contrast between huge headers and small body text. Editorial/luxury feel.' },
  { slug:'deedy-tech', name:'Deedy Resume', category:'Tech', style:'Two-Column Tech', layout:'two-column', description:'Iconic two-column resume popular in software engineering.', accentColor:'#2b2b2b', headerBg:'#2b2b2b', sidebarBg:null, headerText:'#ffffff', featured:true, tags:['two-column','tech','software','popular'], promptStyle:'DEEDY-CV STYLE: Full-width dark (#2b2b2b) header — name VERY LARGE centered white, contact small centered below. Body: EQUAL two columns with thin vertical separator. LEFT: Education most prominent, coursework. RIGHT: Experience (most space), Skills by category. Section headers small ALL-CAPS with horizontal rule. Lato + Raleway fonts. Engineer aesthetic.' },
  { slug:'dev-minimal', name:'Developer Minimal', category:'Tech', style:'Developer Clean', layout:'single', description:'Clean minimalist design optimized for software engineers and developers.', accentColor:'#38A169', headerBg:'#ffffff', sidebarBg:null, headerText:'#1a1a1a', featured:false, tags:['developer','minimal','green','engineer'], promptStyle:'DEVELOPER MINIMAL: Left-aligned header — name bold black, title in green (#38A169), contact on one line | separators, GitHub prominent. Section headers: uppercase green with bottom border. Skills: "Languages: Python, JS" "Frameworks: React..." Monospace for skill names, sans-serif for prose. Arrow (→) bullet markers.' },
  { slug:'altacv-modern', name:'AltaCV Modern', category:'Tech', style:'AltaCV Two-Column', layout:'two-column', description:'Popular two-column layout with light sidebar and teal accent markers.', accentColor:'#0097A7', headerBg:'#ffffff', sidebarBg:'#f5f5f5', headerText:'#1a1a1a', featured:false, tags:['altacv','two-column','teal','sidebar'], promptStyle:'ALTACV MODERN STYLE: Header: large name left. LEFT column (30%, light gray #f5f5f5 bg): Contact, Skills with thin fill bars, Languages. RIGHT column (70%, white): Summary, Experience with teal (#0097A7) event markers, Education. Teal section headers with prefix symbol. Roboto/Inter.' },
  { slug:'tech-dark', name:'Tech Dark Mode', category:'Tech', style:'Dark Terminal', layout:'sidebar', description:'Full dark-mode CV for developers who want a unique technical design.', accentColor:'#68D391', headerBg:'#1a202c', sidebarBg:'#171923', headerText:'#ffffff', featured:false, tags:['dark','terminal','developer','green'], promptStyle:'TECH DARK MODE: ENTIRELY dark-themed. Dark sidebar (#171923) — name in green (#68D391), terminal-style contact with > prefixes. Main area dark (#1a202c), light gray text. Green section headers. Experience like terminal prompts. Skills as code snippets. Fira Code/Courier for headers, sans-serif for descriptions.' },
  { slug:'startup-modern', name:'Startup Modern', category:'Tech', style:'Startup Culture', layout:'single', description:'Energetic design for founders, product managers, and growth professionals.', accentColor:'#7C3AED', headerBg:'#7C3AED', sidebarBg:null, headerText:'#ffffff', featured:false, tags:['startup','product','violet','modern'], promptStyle:'STARTUP MODERN: Violet (#7C3AED) header, white name + italic title. Body white with violet accents. Experience: company large violet bold, role black, date gray right-aligned. Metrics bold in bullets. Tech stack as rounded violet chips. LinkedIn + GitHub as styled badges. Space Grotesk/DM Sans.' },
  { slug:'phd-full', name:'Full PhD CV', category:'Academic', style:'Academic Complete', layout:'single', description:'Comprehensive academic CV for faculty and research positions.', accentColor:'#2C5F8A', headerBg:'#2C5F8A', sidebarBg:null, headerText:'#ffffff', featured:true, tags:['phd','academic','publications','comprehensive'], promptStyle:'FULL ACADEMIC PhD CV: Blue (#2C5F8A) header with name and academic title. ALL sections: Education, Research Experience, Publications (numbered bibliography), Conference Presentations, Teaching, Grants, Awards, Service, Skills, References. Blue section headers with underline rule. Dense clean font. Times New Roman/Garamond. 2+ pages.' },
  { slug:'research-scholar', name:'Research Scholar', category:'Academic', style:'Scholar Format', layout:'single', description:'Focused on research output with publication-ready bibliography formatting.', accentColor:'#8B2252', headerBg:'#ffffff', sidebarBg:null, headerText:'#1a1a1a', featured:false, tags:['research','scholar','crimson','publications'], promptStyle:'RESEARCH SCHOLAR: Left-aligned header — name bold large, institution italic gray, email | ResearchGate | Google Scholar links. Crimson (#8B2252) section headers small caps with hairline underline. "Research Interests" first. Publications in numbered APA format. Georgia/Palatino serif.' },
  { slug:'twenty-seconds', name:'Twenty Seconds', category:'Academic', style:'Quick-Read Sidebar', layout:'sidebar', description:'Communicates your profile in 20 seconds with visual skill progress bars.', accentColor:'#009688', headerBg:'#009688', sidebarBg:'#009688', headerText:'#ffffff', featured:false, tags:['sidebar','skill-bars','teal','quick-read'], promptStyle:'TWENTY-SECONDS CV: Teal (#009688) left sidebar — circular photo placeholder, name white bold, "About Me" 2-3 sentences, SKILLS with CSS progress bar per skill (show % fill), Languages with similar bars. Right: white background, Experience, Education, other sections. Teal markers on entries. Roboto font.' },
  { slug:'mediterranean-blue', name:'Mediterranean Blue', category:'Academic', style:'European Academic', layout:'single', description:'Elegant European-style academic CV with structured blue accents.', accentColor:'#1565C0', headerBg:'#ffffff', sidebarBg:null, headerText:'#1565C0', featured:false, tags:['european','academic','blue','elegant'], promptStyle:'MEDITERRANEAN BLUE: Large name in deep blue (#1565C0), contact info in blue. Each section has blue left accent border (4px solid #1565C0). Alternating subtle background tints (white / #F3F6FB) per section. Structured table-like layout for dates/institutions. Book Antiqua/Palatino serif. Elegant European academic feel.' },
  { slug:'premium-executive', name:'Premium Executive', category:'Executive', style:'Luxury Executive', layout:'single', description:'Sophisticated dark design with gold accents for C-level executives.', accentColor:'#D4AF37', headerBg:'#1C2833', sidebarBg:null, headerText:'#ffffff', featured:true, tags:['executive','gold','dark','luxury','ceo'], promptStyle:'PREMIUM EXECUTIVE: Very dark navy (#1C2833) header — name large white serif, gold (#D4AF37) horizontal rule below, job title gold italic. Body: white background, dark navy section titles, gold decorative elements. Executive Summary first. Experience shows board/P&L language. Key Achievements in gold-bordered box. Playfair Display/EB Garamond serif.' },
  { slug:'leadership-bold', name:'Leadership Bold', category:'Executive', style:'Leadership Profile', layout:'single', description:'Designed for VP, Director, and C-suite roles with leadership focus.', accentColor:'#B7410E', headerBg:'#B7410E', sidebarBg:null, headerText:'#ffffff', featured:false, tags:['leadership','executive','rust','director'], promptStyle:'LEADERSHIP BOLD: Rust (#B7410E) bold header, white name serif, white title. "Executive Profile" summary first. "Core Competencies": 3-column grid of 9-12 leadership skills in bordered cells. Experience shows P&L/team/budget scope. Achievements quantified: "Led 200-person organization, $50M budget". Rust left-border section headers. Crimson Text/Baskerville serif.' },
  { slug:'csuite-minimal', name:'C-Suite Minimal', category:'Executive', style:'Ultra Premium', layout:'single', description:'Ultra-minimal luxury design for CEOs and board-level professionals.', accentColor:'#2C2C2C', headerBg:'#ffffff', sidebarBg:null, headerText:'#2C2C2C', featured:false, tags:['ceo','minimal','ultra-premium','board'], promptStyle:'C-SUITE MINIMAL: White background throughout. Name in MASSIVE thin/light-weight black font (editorial large). Single thin black rule below name. Contact tiny gray minimal. ALL section headers: thin all-caps with extreme letter-spacing. Maximum whitespace. Only major career milestones, board roles, major exits — no skill lists. Cormorant Garamond / Didact Gothic. Truly premium.' },
]
